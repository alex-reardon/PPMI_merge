## Similar as ppmi_merge.py but as functions
## Need to check this 
...
version = '0.0.5_9_14_22' 

df1 = pd.read_csv(userdir + 'ppmi_merge_v0.0.5.csv' )
df1 = df1.reset_index(drop=True)
df1.fillna('NA', inplace = True)
df2 = pd.read_csv(userdir + 'ppmi_merge_v0.0.5_9_14_22.csv' )
df2.fillna('NA', inplace= True)
print(df1)
print(df2)
print(df1.equals(df2))

temp = pd.concat([df1,df2]).drop_duplicates(keep=False)
print(temp)
...
def decode_race(df : pd.DataFrame) : 
...
ppmi_merge = decode_race(ppmi_merge)

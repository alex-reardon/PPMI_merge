...
ppmi_merge['COMPLT'].replace({0 : 'No', 1 : 'Yes'}, inplace = True) 
...
def calculate_subscores(df, new_col_name, subscore_list) : 
    ...
    idx = subscore_only.index[subscore_only.isnull().all(1)] # Get idx of null

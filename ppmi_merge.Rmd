...
updrs_numeric2 = add_extension_to_column_names(updrs_numeric, ['PATNO', 'EVENT_ID', 'PIGD.Subscore', 'Tremor.Subscore', 'Brady.Rigidity.Subscore'], '.Num') # Add a .Num extension to column names w updrs numeric vars 
...
def fill_non_lat_subscore(df, subscore_lateralized_name, subscore_name) : 
    latisna = df[subscore_lateralized_name].isna() & df[subscore_name].isna()
    df[subscore_lateralized_name].loc[latisna] = df[subscore_name].loc[latisna]
    return df 

ppmi_merge = fill_non_lat_subscore(ppmi_merge, 'Tremor.Subscore.lateralized', 'Tremor.Subscore.lateralized')
ppmi_merge = fill_non_lat_subscore(ppmi_merge, 'Brady.Rigidity.Subscore.lateralized', 'Brady.Rigidity.Subscore.lateralized')
